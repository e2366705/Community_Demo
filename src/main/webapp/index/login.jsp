...
<div data-role="page">
		...
		<div data-role="content">
			<form action="<%=basePath %>TourpalController/login.do" method="post" style="padding: 10px 20px;">
				<h3 align="center">
				...
				<input type="text" name="userNumber" id="un" placeholder="请输入账号" /> 
					
				<label	for="un2" class="ui-hidden-accessible">密码:</label> 
				<input	type="text" name="userPw" id="un2" placeholder="请输入密码" />
