...
<div data-role="page">
		...
		<div data-role="content">
			<ul data-role="listview">
				<li><a href="<%=basePath %>index/user_info.jsp"> <img alt="" src="" class="ui-li-icon">
						个人信息查看
				</a></li>
				<li><a href="<%=basePath %>index/user_password.jsp"> <img alt="" src="" class="ui-li-icon">
						个人密码修改
				</a></li>
				<li><a href="<%=basePath %>index/baidu_map.jsp"> <img alt="" src="" class="ui-li-icon">
						百度地图
				</a></li>
