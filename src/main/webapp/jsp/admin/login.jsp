							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form action="UserInfoController/login.do" method="post" onsubmit="return check()">
											<fieldset>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userId"
														...
														placeholder="请输入账号"  value="admin"/> <i class="icon-user"></i>
												</span>
												</label>
												 ...
												 <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userPw"
														...
														placeholder="请输入密码"  value="0000"/> <i class="icon-lock"></i>
												</span>
												</label>
												<div class="clearfix">
													<button type="submit"
