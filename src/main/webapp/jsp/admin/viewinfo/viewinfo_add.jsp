...
<body>
	...
	<form action="ViewInfoController/add.do" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">景区详情</h5>
		<!-- 景区详情5 -->
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<textarea rows="5" cols="" name="viewDesc" placeholder="请输入景区详情"  class="form-control"></textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-3 col-xs-offset-4">
				<input type="submit" class="btn btn-success" value="保存景区" />
